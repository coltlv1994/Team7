...
namespace Interactables
{
    ...
    {
        [SerializeField] private float _interactionDistance = 10f; //from how far can the player start interacting with an object
        [SerializeField] private float _timeoutDistance = 10f; //at what distance does an interaction automatically stop
