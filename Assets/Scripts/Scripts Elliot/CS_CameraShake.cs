...
public class CS_CameraShake : MonoBehaviour //Created by Elliot 
{
    // m_cameraShake = FindAnyObjectByType<CS_CameraShake>(); - Take this into Start, Awake or OnEnable of the script that will start camera shake
